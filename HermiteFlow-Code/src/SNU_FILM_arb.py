# --------------------------------------------------------
# HermiteFlow-VFI — SNU-FILM Arbitrary benchmark
# Adapted from GIMM-VFI's SNU_FILM_arb.py
# --------------------------------------------------------
...
def default_parser():
    ...
    parser.add_argument(
        "-m", "--model-config", type=str, default="configs/hermiteflow/hermiteflow_r.yaml"
    )
    parser.add_argument(
